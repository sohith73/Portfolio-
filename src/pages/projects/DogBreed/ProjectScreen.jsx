...
const ProjectScreen = () => {
     return (
          ...
          ><div className='bg-[#030014] w-full h-full inset-0 z-[20]'>
                    <NavProject title={'DOG breed FInder'} />
                    <motion.div
                         initial="hidden"
                         animate="visible"
                    ...
                    >
                         <div className="flex flex-col gap-5 justify-center md:justify-start m-auto md:m-0 text-start w-full md:w-full h-full">
                              ...
                              >
                                   ...
                                   <h1 className="Welcome-text text-sm">DOG breed FInder</h1>
                              </motion.div>
                                   ...
                                   <div className="w-full md:w-1/2">
                                        ...
                                        >
                                             <iframe
                                                  width="100%"
                                                  height="315"
                                                  src="https://www.youtube.com/embed/aNWBO8YTzlc?si=dzVwrmPHlNhv5Z7u?autoplay=1"
                                                  title="BSC's player "
