...
const ProjectsMain = () => {
     ...
     return (
          ...
          >
               ...
               <motion.div>
                    <motion.p className='text-[40px] font-semibold text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-red-500 py-20'>
